    ...
    <main class="container-fluid row vh-100 p-0 m-0">
        <?php include "views/views_linkmenu.php"?>
            <section class="col-md-10 col-sm-12 p-0">
                <div class="d-flex justify-content-sm-center justify-content-md-end  text-end m-3 container_buscar">
                <?php include "views/views_buscar.php"?>  
                </div>
               ...
               <?php foreach ($listas as $lista):?>
                    ...
                    <?php endforeach; ?>                    
                    <?php else: echo "<h1 class='text-center text-info'>No tenemos esta categoria disponible</h1>";
                    endif; ?>
               </div>
            </section>
    </main>
